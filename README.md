...
Before I started learning how to use OpenCV, I started with learning the theory. I particularly enjoyed Shree Nayar's course "First Principles of Computer Vision". With this course, I'll list other lectures that could be useful.
| Course | Description |
| --- | --- |
